!function(){
	...
	// !based on joe walnes gcode viewer
	...
	* 
	* Special command:
	*   'default': Called if no other command matches.
	*/
	 	...
	 	var parseHandler = {  	
							  ...
							  COMMENT: function(args){
							  	  ...
							  	  if(tags.indexOf(args.tag) >= 0){
								  	  gcm.meta = gcm.meta != null ? gcm.meta : {};
								  	  gcm.meta[args.tag] = args.val;
